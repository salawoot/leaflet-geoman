...
(() => {
    ...
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let n of Gl(e))
        !Nl.call(t, n) &&
          ...
          Yi(t, n, {
            get: () => e[n],
            enumerable: !(r = Al(e, n)) || r.enumerable,
          });
    return t;
  };
  var wt = (t, e, i) => (
    ...
    zl(
      e || !t || !t.__esModule
        ? Yi(i, 'default', { value: t, enumerable: !0 })
        : i,
      t
    )
  );
  ...
  var ae = T((y_, Qi) => {
    var Ul = se();
    function Kl(t, e) {
      for (var i = t.length; i--; ) if (Ul(t[i][0], e)) return i;
      return -1;
    }
    Qi.exports = Kl;
  });
  var er = T((L_, tr) => {
    ...
    function Jl(t) {
      ...
      if (i < 0) return !1;
      var r = e.length - 1;
      return (i == r ? e.pop() : Yl.call(e, i, 1), --this.size, !0);
    }
    tr.exports = Jl;
  });
  var rr = T((b_, ir) => {
  ...
  var oe = T((v_, lr) => {
    ...
    jt.prototype.clear = ih;
    jt.prototype.delete = rh;
    jt.prototype.get = nh;
    jt.prototype.has = sh;
    jt.prototype.set = ah;
    lr.exports = jt;
  ...
  var vr = T((T_, Mr) => {
    var br = Se(),
      kr = Object.prototype,
      yh = kr.hasOwnProperty,
      Lh = kr.toString,
      le = br ? br.toStringTag : void 0;
    function bh(t) {
      var e = yh.call(t, le),
        i = t[le];
      try {
  ...
  var Be = T((I_, Br) => {
    ...
    function Ah(t) {
      if (!Th(t)) return !1;
      var e = Bh(t);
      return e == Rh || e == Oh || e == Dh || e == Ih;
    }
    Br.exports = Ah;
  });
  var Dr = T((A_, Tr) => {
    var Gh = It(),
      qh = Gh['__core-js_shared__'];
    Tr.exports = qh;
  });
  var Ir = T((G_, Or) => {
    var ei = Dr(),
  ...
  var Qr = T((X_, Wr) => {
    var _c = he(),
      yc = Object.prototype,
      Lc = yc.hasOwnProperty;
    function bc(t) {
      var e = this.__data__;
      return _c ? e[t] !== void 0 : Lc.call(e, t);
    }
    Wr.exports = bc;
  });
  var en = T((Y_, tn) => {
  ...
  var ce = T((W_, cn) => {
    ...
    function Oc(t, e) {
      var i = t.__data__;
      return Rc(e) ? i[typeof e == 'string' ? 'string' : 'hash'] : i.map;
    }
    cn.exports = Oc;
  });
  var pn = T((Q_, un) => {
  ...
  var ri = T((ry, Ln) => {
    ...
    Kt.prototype.clear = Vc;
    Kt.prototype.delete = Uc;
    Kt.prototype.get = Kc;
    Kt.prototype.has = Hc;
    Kt.prototype.set = Xc;
    Ln.exports = Kt;
  ...
  var vn = T((sy, Mn) => {
    var Qc = oe(),
      ...
      nu = kn();
    function Ht(t) {
      var e = (this.__data__ = new Qc(t));
      this.size = e.size;
    }
    Ht.prototype.clear = tu;
  ...
  var ni = T((ay, xn) => {
    var su = Te(),
      au = (function () {
        try {
          var t = su(Object, 'defineProperty');
          return (t({}, '', {}), t);
        } catch {}
      })();
    xn.exports = au;
  ...
  var De = T((oy, Cn) => {
    ...
    function ou(t, e, i) {
      e == '__proto__' && wn
        ? wn(t, e, { configurable: !0, enumerable: !0, value: i, writable: !0 })
        : (t[e] = i);
    }
    Cn.exports = ou;
  });
  var si = T((ly, En) => {
    var lu = De(),
      hu = se();
    function cu(t, e, i) {
      ((i !== void 0 && !hu(t[e], i)) || (i === void 0 && !(e in t))) &&
        lu(t, e, i);
    }
    En.exports = cu;
  });
  ...
  var An = T((ue, Xt) => {
    var du = It(),
      In = typeof ue == 'object' && ue && !ue.nodeType && ue,
      Dn = In && typeof Xt == 'object' && Xt && !Xt.nodeType && Xt,
      gu = Dn && Dn.exports === In,
      Rn = gu ? du.Buffer : void 0,
      On = Rn ? Rn.allocUnsafe : void 0;
    function mu(t, e) {
      if (e) return t.slice();
      var i = t.length,
        r = On ? On(i) : new t.constructor(i);
      return (t.copy(r), r);
    }
    Xt.exports = mu;
  });
  ...
  var ai = T((_y, Zn) => {
    var Cu = $n(),
      Eu = Cu(Object.getPrototypeOf, Object);
    Zn.exports = Eu;
  });
  var oi = T((yy, Wn) => {
    ...
    function Su(t) {
      var e = t && t.constructor,
        i = (typeof e == 'function' && e.prototype) || Pu;
      return t === i;
    }
    Wn.exports = Su;
  });
  var ts = T((Ly, Qn) => {
    var Bu = Yn(),
      ...
      Du = oi();
    function Ru(t) {
      return typeof t.constructor == 'function' && !Du(t) ? Bu(Tu(t)) : {};
    }
    Qn.exports = Ru;
  });
  var At = T((by, es) => {
  ...
  var li = T((My, as) => {
    var ns = rs(),
      ...
      ju = ns(
        ...
        ? ns
        : function (t) {
            return Nu(t) && zu.call(t, 'callee') && !Fu.call(t, 'callee');
          };
    as.exports = ju;
  });
  var Yt = T((vy, os) => {
  ...
  var Re = T((wy, hs) => {
    var Hu = Be(),
      Xu = hi();
    function Yu(t) {
      return t != null && Xu(t.length) && !Hu(t);
    }
    hs.exports = Yu;
  });
  var us = T((Cy, cs) => {
  ...
  var ci = T((pe, Jt) => {
    var Qu = It(),
      tp = fs(),
      ms = typeof pe == 'object' && pe && !pe.nodeType && pe,
      ds = ms && typeof Jt == 'object' && Jt && !Jt.nodeType && Jt,
      ep = ds && ds.exports === ms,
      gs = ep ? Qu.Buffer : void 0,
      ip = gs ? gs.isBuffer : void 0,
      rp = ip || tp;
    Jt.exports = rp;
  });
  var Ls = T((Py, ys) => {
    var np = Vt(),
      ...
      hp = Object.prototype,
      _s = lp.toString,
      cp = hp.hasOwnProperty,
      up = _s.call(Object);
    function pp(t) {
      if (!ap(t) || np(t) != op) return !1;
      var e = sp(t);
      if (e === null) return !0;
      var i = cp.call(e, 'constructor') && e.constructor;
      return typeof i == 'function' && i instanceof i && _s.call(i) == up;
    }
    ys.exports = pp;
  });
  var ks = T((Sy, bs) => {
    var fp = Vt(),
      ...
      Np = '[object Uint32Array]',
      J = {};
    J[Tp] = J[Dp] = J[Rp] = J[Op] = J[Ip] = J[Ap] = J[Gp] = J[qp] = J[Np] = !0;
    J[mp] =
      J[_p] =
      J[Sp] =
      J[yp] =
      ...
      J[Pp] =
        !1;
    function zp(t) {
      return gp(t) && dp(t.length) && !!J[fp(t)];
    }
    bs.exports = zp;
  });
  var vs = T((By, Ms) => {
  ...
  var ws = T((fe, $t) => {
    var jp = ti(),
      xs = typeof fe == 'object' && fe && !fe.nodeType && fe,
      de = xs && typeof $t == 'object' && $t && !$t.nodeType && $t,
      Vp = de && de.exports === xs,
      ui = Vp && jp.process,
      Up = (function () {
        try {
  ...
  var Ts = T((Ry, Bs) => {
    var Jp = De(),
      $p = se(),
      Zp = Object.prototype,
      Wp = Zp.hasOwnProperty;
    function Qp(t, e, i) {
      var r = t[e];
      (!(Wp.call(t, e) && $p(r, i)) || (i === void 0 && !(e in t))) &&
        Jp(t, e, i);
    }
    Bs.exports = Qp;
  });
  var Rs = T((Oy, Ds) => {
    ...
    function rf(t, e, i, r) {
      ...
      for (var s = -1, a = e.length; ++s < a; ) {
        var o = e[s],
          h = r ? r(i[o], t[o], o, i, t) : void 0;
        (h === void 0 && (h = t[o]), n ? ef(i, o, h) : tf(i, o, h));
      }
      return i;
    }
    Ds.exports = rf;
  ...
  var js = T((Ny, Fs) => {
    var yf = Ct(),
      ...
      bf = zs(),
      kf = Object.prototype,
      Mf = kf.hasOwnProperty;
    function vf(t) {
      if (!yf(t)) return bf(t);
      var e = Lf(t),
        i = [];
      for (var r in t)
        (r == 'constructor' && (e || !Mf.call(t, r))) || i.push(r);
      return i;
    }
    Fs.exports = vf;
  });
    ...
    function Ws(t, e, i, r, n) {
      t !== e &&
        Kf(
          e,
          function (s, a) {
            if ((n || (n = new Vf()), Xf(s))) Hf(t, e, a, i, Ws, r, n);
            else {
              var o = r ? r(Jf(t, a), s, a + '', t, e, n) : void 0;
              (o === void 0 && (o = s), Uf(t, a, o));
            }
          },
          Yf
        );
  ...
  var aa = T((Hy, sa) => {
    ...
    function Qf(t, e, i) {
      return (
        (e = na(e === void 0 ? t.length - 1 : e, 0)),
        function () {
          for (
            var r = arguments, n = -1, s = na(r.length - e, 0), a = Array(s);
            ++n < s;
          )
            a[n] = r[e + n];
          n = -1;
          for (var o = Array(e + 1); ++n < e; ) o[n] = r[n];
          return ((o[e] = i(a)), Wf(t, this, o));
        }
      );
    }
    sa.exports = Qf;
  ...
  var La = T((Wy, ya) => {
    ...
    function Ld(t, e, i) {
      ...
      var r = typeof e;
      return (
        r == 'number' ? md(i) && _d(e, i.length) : r == 'string' && e in i
      )
        ? gd(i[e], t)
        : !1;
    }
      ...
      return bd(function (e, i) {
        ...
        for (
          s = t.length > 3 && typeof s == 'function' ? (n--, s) : void 0,
            a && kd(i[0], i[1], a) && ((s = n < 3 ? void 0 : s), (n = 1)),
            e = Object(e);
          ++r < n;
        ) {
          var o = i[r];
  ...
  var Ie = T((cb, io) => {
    var og = Vt(),
      ...
      hg = '[object Symbol]';
    function cg(t) {
      return typeof t == 'symbol' || (lg(t) && og(t) == hg);
    }
    io.exports = cg;
  });
  var no = T((ub, ro) => {
    ...
    function gg(t, e) {
      ...
      return i == 'number' ||
        ...
        pg(t)
        ? !0
        : dg.test(t) || !fg.test(t) || (e != null && t in Object(e));
    }
    ro.exports = gg;
  });
  var oo = T((pb, ao) => {
    ...
    function yi(t, e) {
      ...
      return ((i.cache = new (yi.Cache || so)()), i);
    }
    yi.Cache = so;
    ao.exports = yi;
  });
  var ho = T((fb, lo) => {
    var _g = oo(),
      yg = 500;
    function Lg(t) {
      var e = _g(t, function (r) {
          return (i.size === yg && i.clear(), r);
        }),
        i = e.cache;
      return e;
    }
    ...
    var bg = ho(),
      ...
      vg = bg(function (t) {
        ...
        return (
          ...
          t.replace(kg, function (i, r, n, s) {
            e.push(n ? s.replace(Mg, '$1') : r || i);
          }),
          e
        );
      });
  ...
  var bo = T((mb, Lo) => {
    var go = Se(),
      ...
      Eg = Ie(),
      Pg = 1 / 0,
      mo = go ? go.prototype : void 0,
      _o = mo ? mo.toString : void 0;
    function yo(t) {
      if (typeof t == 'string') return t;
      if (Cg(t)) return wg(t, yo) + '';
      if (Eg(t)) return _o ? _o.call(t) : '';
      var e = t + '';
  ...
  var xo = T((yb, vo) => {
    var Tg = Yt(),
      ...
      Og = Mo();
    function Ig(t, e) {
      return Tg(t) ? t : Dg(t, e) ? [t] : Rg(Og(t));
    }
    vo.exports = Ig;
  });
  var Co = T((Lb, wo) => {
    var Ag = Ie(),
      Gg = 1 / 0;
    function qg(t) {
      if (typeof t == 'string' || Ag(t)) return t;
      var e = t + '';
      return e == '0' && 1 / t == -Gg ? '-0' : e;
    }
    wo.exports = qg;
  });
  var Po = T((bb, Eo) => {
    ...
    function Fg(t, e) {
      e = Ng(e, t);
      for (var i = 0, r = e.length; t != null && i < r; ) t = t[zg(e[i++])];
  ...
  var jo = T((Ei, Pi) => {
    (function (t, e) {
          ...
          for (; u > c; ) {
            if (u - c > 600) {
              var y = u - c + 1,
                _ = q - c + 1,
                v = Math.log(y),
                E = 0.5 * Math.exp((2 * v) / 3),
                b =
                  0.5 *
                  Math.sqrt((v * E * (y - E)) / y) *
                  (_ - y / 2 < 0 ? -1 : 1),
                x = Math.max(c, Math.floor(q - (_ * E) / y + b)),
                P = Math.min(u, Math.floor(q + ((y - _) * E) / y + b));
              I(G, q, x, P, p);
            }
            var C = G[q],
              B = c,
              N = u;
            for (e(G, c, q), p(G[u], C) > 0 && e(G, c, u); B < N; ) {
              for (e(G, B, N), B++, N--; p(G[B], C) < 0; ) B++;
              for (; p(G[N], C) > 0; ) N--;
            }
            (p(G[c], C) === 0 ? e(G, c, N) : e(G, ++N, u),
              N <= q && (c = N + 1),
              q <= N && (u = N - 1));
          }
      ...
      function A(g, M, m, O, R) {
        for (var I = [M, m]; I.length; )
          if (!((m = I.pop()) - (M = I.pop()) <= O)) {
      ...
      return (
          ...
          for (var O = this.toBBox, R = []; M; ) {
            for (var I = 0; I < M.children.length; I++) {
              var G = M.children[I],
                q = M.leaf ? O(G) : G;
              w(g, q) &&
                (M.leaf ? m.push(G) : k(g, q) ? this._all(G, m) : R.push(G));
            }
            M = R.pop();
          }
          return m;
        ...
        (r.prototype.remove = function (g, M) {
          if (!g) return this;
          for (
            var m, O, R, I = this.data, G = this.toBBox(g), q = [], c = [];
            I || q.length;
          ) {
            if (
              (I ||
                ((I = q.pop()), (O = q[q.length - 1]), (m = c.pop()), (R = !0)),
              I.leaf)
            ) {
              var u = n(g, I.children, M);
              if (u !== -1)
                return (
                  I.children.splice(u, 1), q.push(I), this._condense(q), this
                );
            }
            R || I.leaf || !k(I, G)
              ? O
                ? (m++, (I = O.children[m]), (R = !1))
                : (I = null)
              : (q.push(I), c.push(m), (m = 0), (O = I), (I = I.children[0]));
          }
          return this;
        }),
        ...
        (r.prototype._all = function (g, M) {
          for (var m = []; g; )
            (g.leaf ? M.push.apply(M, g.children) : m.push.apply(m, g.children),
              (g = m.pop()));
          return M;
        }),
        (r.prototype._build = function (g, M, m, O) {
          ...
          (O ||
            ((O = Math.ceil(Math.log(I) / Math.log(G))),
            (G = Math.ceil(I / Math.pow(G, O - 1)))),
            ((R = S([])).leaf = !1),
            (R.height = O));
          var q = Math.ceil(I / G),
            c = q * Math.ceil(Math.sqrt(G));
            ...
            for (
              ...
              var c = M.children[q],
                ...
                p =
                  ((y = g),
                  (_ = c),
                  (Math.max(_.maxX, y.maxX) - Math.min(_.minX, y.minX)) *
                    (Math.max(_.maxY, y.maxY) - Math.min(_.minY, y.minY)) -
                    u);
              p < I
                ? ((I = p), (R = u < R ? u : R), (G = c))
                : p === I && u < R && ((R = u), (G = c));
        ...
        (r.prototype._insert = function (g, M, m) {
          var O = m ? g : this.toBBox(g),
            R = [],
            I = this._chooseSubtree(O, this.data, M, R);
          for (
            I.children.push(g), o(I, O);
            M >= 0 && R[M].children.length > this._maxEntries;
          )
            (this._split(R, M), M--);
        ...
        (r.prototype._split = function (g, M) {
          ...
          var I = this._chooseSplitIndex(m, R, O),
            G = S(m.children.splice(I, m.children.length - I));
          ((G.height = m.height),
            (G.leaf = m.leaf),
            s(m, this.toBBox),
            s(G, this.toBBox),
            M ? g[M - 1].children.push(G) : this._splitRoot(m, G));
        }),
        ...
        (r.prototype._chooseSplitIndex = function (g, M, m) {
          for (
            var O, R, I, G, q, c, u, p = 1 / 0, y = 1 / 0, _ = M;
            _ <= m - M;
            _++
          ) {
            var v = a(g, 0, _, this.toBBox),
              ...
              b =
                ...
                (c = void 0),
                (u = void 0),
                (G = Math.max(R.minX, I.minX)),
                (q = Math.max(R.minY, I.minY)),
                (c = Math.min(R.maxX, I.maxX)),
                (u = Math.min(R.maxY, I.maxY)),
                Math.max(0, c - G) * Math.max(0, u - q)),
              x = d(v) + d(E);
            b < p
              ? ((p = b), (O = _), (y = x < y ? x : y))
              : b === p && x < y && ((y = x), (O = _));
        ...
        (r.prototype._chooseSplitAxis = function (g, M, m) {
          var O = g.leaf ? this.compareMinX : h,
            R = g.leaf ? this.compareMinY : l;
          this._allDistMargin(g, M, m, O) < this._allDistMargin(g, M, m, R) &&
            g.children.sort(O);
        }),
        ...
        (r.prototype._condense = function (g) {
          for (var M = g.length - 1, m = void 0; M >= 0; M--)
            g[M].children.length === 0
              ? M > 0
                ? (m = g[M - 1].children).splice(m.indexOf(g[M]), 1)
                : this.clear()
              : s(g[M], this.toBBox);
        }),
        r
  ...
  var Ji = {
    ...
    'lint-staged': { '*.js': 'oxlint --fix', '*.{js,css}': 'oxfmt --write' },
  };
  var Mi = wt(Oe());
  var va = {
    tooltips: {
  ...
  var Pa = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\u041A\u043E\u0441\u043D\u0438\u0442\u0435\u0441\u044C \u043A\u0430\u0440\u0442\u044B, \u0447\u0442\u043E\u0431\u044B \u0440\u0430\u0437\u043C\u0435\u0441\u0442\u0438\u0442\u044C \u043C\u0430\u0440\u043A\u0435\u0440',
      firstVertex:
  ...
  var Aa = {
    tooltips: {
      ...
      placeMarkerTouch: 'Tryck p\xE5 kartan f\xF6r att placera en mark\xF6r',
  ...
  var Ga = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\u03A0\u03B1\u03C4\u03AE\u03C3\u03C4\u03B5 \u03C3\u03C4\u03BF \u03C7\u03AC\u03C1\u03C4\u03B7 \u03B3\u03B9\u03B1 \u03BD\u03B1 \u03C4\u03BF\u03C0\u03BF\u03B8\u03B5\u03C4\u03AE\u03C3\u03B5\u03C4\u03B5 \u03B4\u03B5\u03AF\u03BA\u03C4\u03B7',
      firstVertex:
  ...
  var qa = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\xC9rintse meg a t\xE9rk\xE9pet a jel\xF6l\u0151 elhelyez\xE9s\xE9hez',
  ...
  var Na = {
    tooltips: {
      ...
      placeMarkerTouch: 'Tryk p\xE5 kortet for at placere en mark\xF8r',
  ...
  var za = {
    tooltips: {
      ...
      placeMarkerTouch: 'Trykk p\xE5 kartet for \xE5 plassere et punkt',
  ...
  var Fa = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\u0631\u0648\u06CC \u0646\u0642\u0634\u0647 \u0636\u0631\u0628\u0647 \u0628\u0632\u0646\u06CC\u062F \u062A\u0627 \u0646\u0634\u0627\u0646 \u0628\u06AF\u0630\u0627\u0631\u06CC\u062F',
      firstVertex:
  ...
  var ja = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\u0422\u043E\u0440\u043A\u043D\u0456\u0442\u044C\u0441\u044F \u043A\u0430\u0440\u0442\u0438, \u0449\u043E\u0431 \u0440\u043E\u0437\u043C\u0456\u0441\u0442\u0438\u0442\u0438 \u043C\u0430\u0440\u043A\u0435\u0440',
      firstVertex:
  ...
  var Va = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\u0130\u015Faret\xE7i yerle\u015Ftirmek i\xE7in haritaya dokunun',
      firstVertex:
  ...
  var Ua = {
    tooltips: {
      ...
      placeMarkerTouch: 'Klepnut\xEDm na mapu um\xEDst\xEDte zna\u010Dku',
  ...
  var Ya = {
    tooltips: {
      ...
      placeMarkerTouch:
        '\u041C\u0430\u0440\u043A\u0435\u0440\u0434\u0438 \u0436\u0430\u0439\u0433\u0430\u0448\u0442\u044B\u0440\u0443\u0443 \u04AF\u0447\u04AF\u043D \u043A\u0430\u0440\u0442\u0430\u0433\u0430 \u0442\u0438\u0439\u0438\u04A3\u0438\u0437',
      firstVertex:
  ...
  var Ja = {
    tooltips: {
      placeMarker:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E07\u0E2B\u0E21\u0E38\u0E14',
      placeMarkerTouch:
        '\u0E41\u0E15\u0E30\u0E41\u0E1C\u0E19\u0E17\u0E35\u0E48\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E07\u0E2B\u0E21\u0E38\u0E14',
      firstVertex:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E07\u0E08\u0E38\u0E14\u0E41\u0E23\u0E01',
      continueLine:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E14\u0E15\u0E48\u0E2D',
      finishLine:
        '\u0E04\u0E25\u0E34\u0E01\u0E17\u0E35\u0E48\u0E2B\u0E21\u0E38\u0E14\u0E43\u0E14\u0E01\u0E47\u0E44\u0E14\u0E49\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E2A\u0E23\u0E47\u0E08\u0E2A\u0E34\u0E49\u0E19',
      finishPoly:
        '\u0E04\u0E25\u0E34\u0E01\u0E17\u0E35\u0E48\u0E2B\u0E21\u0E38\u0E14\u0E41\u0E23\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E2A\u0E23\u0E47\u0E08\u0E2A\u0E34\u0E49\u0E19',
      finishRect:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E2A\u0E23\u0E47\u0E08\u0E2A\u0E34\u0E49\u0E19',
      startCircle:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E07\u0E08\u0E38\u0E14\u0E28\u0E39\u0E19\u0E22\u0E4C\u0E01\u0E25\u0E32\u0E07\u0E27\u0E07\u0E01\u0E25\u0E21',
      finishCircle:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E40\u0E2A\u0E23\u0E47\u0E08\u0E2A\u0E34\u0E49\u0E19\u0E27\u0E07\u0E01\u0E25\u0E21',
      placeCircleMarker:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E07\u0E2B\u0E21\u0E38\u0E14\u0E27\u0E07\u0E01\u0E25\u0E21',
      placeText:
        '\u0E04\u0E25\u0E34\u0E01\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E27\u0E32\u0E07\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21',
      selectFirstLayerFor:
        '\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C\u0E41\u0E23\u0E01\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A {action}',
      selectSecondLayerFor:
        '\u0E40\u0E25\u0E37\u0E2D\u0E01\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C\u0E17\u0E35\u0E48\u0E2A\u0E2D\u0E07\u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A {action}',
    },
    actions: {
      finish: '\u0E40\u0E2A\u0E23\u0E47\u0E08\u0E2A\u0E34\u0E49\u0E19',
      cancel: '\u0E22\u0E01\u0E40\u0E25\u0E34\u0E01',
    ...
    buttonTitles: {
      drawMarkerButton: '\u0E27\u0E32\u0E14\u0E2B\u0E21\u0E38\u0E14',
      drawPolyButton:
        '\u0E27\u0E32\u0E14\u0E23\u0E39\u0E1B\u0E2B\u0E25\u0E32\u0E22\u0E40\u0E2B\u0E25\u0E35\u0E48\u0E22\u0E21',
      drawLineButton: '\u0E27\u0E32\u0E14\u0E40\u0E2A\u0E49\u0E19',
      drawCircleButton: '\u0E27\u0E32\u0E14\u0E27\u0E07\u0E01\u0E25\u0E21',
      drawRectButton:
        '\u0E27\u0E32\u0E14\u0E2A\u0E35\u0E48\u0E40\u0E2B\u0E25\u0E35\u0E48\u0E22\u0E21',
      editButton:
        '\u0E41\u0E01\u0E49\u0E44\u0E02\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C',
      dragButton:
        '\u0E25\u0E32\u0E01\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C',
      cutButton: '\u0E15\u0E31\u0E14\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C',
      deleteButton: '\u0E25\u0E1A\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C',
      drawCircleMarkerButton:
        '\u0E27\u0E32\u0E14\u0E2B\u0E21\u0E38\u0E14\u0E27\u0E07\u0E01\u0E25\u0E21',
      snappingButton:
        '\u0E14\u0E39\u0E14\u0E2B\u0E21\u0E38\u0E14\u0E17\u0E35\u0E48\u0E25\u0E32\u0E01\u0E43\u0E2B\u0E49\u0E40\u0E01\u0E32\u0E30\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C\u0E41\u0E25\u0E30\u0E08\u0E38\u0E14\u0E2D\u0E37\u0E48\u0E19',
      pinningButton:
        '\u0E25\u0E47\u0E2D\u0E01\u0E08\u0E38\u0E14\u0E23\u0E48\u0E27\u0E21\u0E44\u0E27\u0E49\u0E14\u0E49\u0E27\u0E22\u0E01\u0E31\u0E19',
      rotateButton:
        '\u0E2B\u0E21\u0E38\u0E19\u0E40\u0E25\u0E40\u0E22\u0E2D\u0E23\u0E4C',
      drawTextButton:
        '\u0E27\u0E32\u0E14\u0E02\u0E49\u0E2D\u0E04\u0E27\u0E32\u0E21',
  ...
  var ag = () => ({
      ...
      _handleEscapeKey(t) {
        let e = this.map.pm;
        return !e.getGlobalOptions().exitModeOnEscape ||
          !(
            e.globalDrawModeEnabled() ||
            e.globalEditModeEnabled() ||
            e.globalDragModeEnabled() ||
            e.globalRemovalModeEnabled() ||
            e.globalRotateModeEnabled() ||
            e.globalCutModeEnabled()
          )
          ? !1
          : (t.preventDefault(),
            e.globalDrawModeEnabled() && e.disableDraw(),
            e.globalEditModeEnabled() && e.disableGlobalEditMode(),
            e.globalDragModeEnabled() && e.disableGlobalDragMode(),
            e.globalRemovalModeEnabled() && e.disableGlobalRemovalMode(),
            e.globalRotateModeEnabled() && e.disableGlobalRotateMode(),
            e.globalCutModeEnabled() && e.disableGlobalCutMode(),
            !0);
      },
      _handleEnterKey(t) {
        let e = this.map.pm;
        ...
        if (!r) return !1;
        let n = e.Draw[r];
        return !n || !n._finishShape || !this._canFinishShape(n, r)
          ? !1
          : (t.preventDefault(), n._finishShape(), !0);
      },
      _canFinishShape(t, e) {
        if (['Marker', 'CircleMarker', 'Text'].includes(e)) return !1;
        if (e === 'Rectangle') return t._startMarker !== void 0;
        if (e === 'Circle')
          return t._centerMarker && t._layerGroup?.hasLayer(t._centerMarker);
      ...
      _onKeyListener(t) {
        ...
        ((this._lastEvents[t.type] = i),
          ...
          t.type === 'keydown' &&
            (t.key === 'Escape' && this._handleEscapeKey(t),
            t.key === 'Enter' && this._handleEnterKey(t)));
      },
      _onBlur(t) {
        t.altKey = !1;
  ...
  function Ug(t, e, i) {
    let r = { a: L.CRS.Earth.R, b: 63567523142e-4, f: 0.0033528106647474805 },
      ...
      O = 1 - m * m,
      R = (O * (n * n - s * s)) / (s * s),
      I = 1 + (R / 16384) * (4096 + R * (-768 + R * (320 - 175 * R))),
      G = (R / 1024) * (256 + R * (-128 + R * (74 - 47 * R))),
      q = l / (s * I),
      c = 2 * Math.PI,
      u,
      p,
    ...
    for (; Math.abs(q - c) > 1e-12; ) {
      ...
      let B =
        ...
        (u +
          (G / 4) *
            (y * (-1 + 2 * u * u) -
              (G / 6) * u * (-3 + 4 * p * p) * (-3 + 4 * u * u)));
      ((c = q), (q = l / (s * I) + B));
    }
    let _ = g * p - A * y * w,
      v = Math.atan2(g * y + A * p * w, (1 - a) * Math.sqrt(m * m + _ * _)),
      E = Math.atan2(p * k, A * y - g * p * w),
      b = (a / 16) * O * (4 + a * (4 - 3 * O)),
      x = E - (1 - b) * a * m * (q + b * p * (u + b * y * (-1 + 2 * u * u))),
      P = o + (x * 180) / d,
      C = (v * 180) / d;
    return L.latLng(P, C);
  }
  function bi(t, e, i, r, n = !0) {
    ...
    for (let l = 0; l < i; l += 1) {
      if (n)
        ...
        let d = t.lat + Math.cos((2 * l * Math.PI) / i) * e,
          f = t.lng + Math.sin((2 * l * Math.PI) / i) * e;
        o = L.latLng(d, f);
      }
      h.push(o);
    }
  ...
  function Kg(t, e, i) {
    ...
    let r = Math.PI / 180,
      ...
      f = Math.cos(i / s),
      k = Math.sin(i / s),
      w = Math.asin(l * f + d * k * Math.cos(h)),
      S = a + Math.atan2(Math.sin(h) * k * d, f - l * Math.sin(w));
    S *= n;
    let A = S - 360,
      g = S < -180 ? S + 360 : S;
  ...
  function To(t, e, i = 'asc') {
    ...
    return (h, l) => {
      ...
      let k = d in a ? a[d] : Number.MAX_SAFE_INTEGER,
  ...
  var Hg = L.Class.extend({
      includes: [$a, Za, Wa, Qa, Pt],
      initialize(t) {
        ((this.map = t),
      ...
      setLang(t = 'en', e, i = 'en') {
        ...
        (e && (Et[t] = (0, Mi.default)(Et[i], e)),
          (L.PM.activeLang = t),
          this.map.pm.Toolbar.reinit(),
          this._fireLangChange(r, t, i, Et[t]));
      },
      addControls(t) {
      ...
      _canvasTouchClick(t) {
        ...
        (t.type === 'touchstart' || t.type === 'pointerdown'
          ...
          : (t.type === 'touchend' ||
            ...
            (e = 'mouseup'),
          e && St(this.map)._onClick(this._createMouseEvent(e, t)));
      },
  ...
  var Xg = L.Control.extend({
      ...
      _makeButton(t) {
        ...
        ((t._preparedActions = s.map((h) => {
          let l = typeof h == 'string' ? h : h.name,
            d;
          if (a[l]) d = a[l];
          else if (h.text) d = h;
          else return d;
          let f = L.DomUtil.create(
            'a',
            `leaflet-pm-action ${e} action-${l}`,
            n
          );
          if (
            ...
            L.DomEvent.on(f, 'click', L.DomEvent.stop),
            (d._node = f),
            !t.disabled && d.onClick)
          ) {
            let k = (w) => {
              w.preventDefault();
              let S = '',
                { buttons: A } = this._map.pm.Toolbar;
              for (let g in A)
                if (A[g]._button === t) {
                  S = g;
                  break;
            ...
            (L.DomEvent.addListener(f, 'click', k, this),
              L.DomEvent.addListener(f, 'click', d.onClick, this),
              L.DomEvent.addListener(f, 'click', () =>
    ...
    Oo = Xg;
  L.Control.PMButton = Oo;
  var Yg = L.Class.extend({
      options: {
        drawMarker: !0,
        drawRectangle: !0,
        drawPolyline: !0,
      ...
      _defineButtons() {
        ...
        (this._addButton('drawMarker', new L.Control.PMButton(t)),
          ...
          this._addButton('drawText', new L.Control.PMButton(f)),
          ...
          this._addButton('removalMode', new L.Control.PMButton(l)),
      ...
      changeControlOrder(t = []) {
        ...
        (i.forEach((l) => {
          ...
          Object.keys(r)
            .filter((l) => !r[l]._button.tool || r[l]._button.tool === 'draw')
            .forEach((l) => {
              i.indexOf(l) === -1 && (n[l] = r[l]);
            }),
          Object.keys(r)
            .filter((l) => r[l]._button.tool === 'edit')
            .forEach((l) => {
              i.indexOf(l) === -1 && (n[l] = r[l]);
            }),
          Object.keys(r)
            .filter((l) => r[l]._button.tool === 'options')
            .forEach((l) => {
              i.indexOf(l) === -1 && (n[l] = r[l]);
            }),
          Object.keys(r)
            .filter((l) => r[l]._button.tool === 'custom')
            .forEach((l) => {
              i.indexOf(l) === -1 && (n[l] = r[l]);
            }),
  ...
  var Jg = {
      ...
      _handleSnapping(t, e = !1) {
        ...
        if (
          ...
          t?.originalEvent?.altKey || this._map?.pm?.Keyboard.isAltKeyPressed())
        )
          return !1;
        let r;
        if (e) {
        ...
        if (
          (this._fireSnapDrag(h.marker, h),
          this._fireSnapDrag(this._layer, h),
          n.distance < o)
        ) {
          ...
          this._snapLatLng &&
            ...
            (i._snapped = !1),
            (i._snapInfo = void 0),
            this._fireUnsnap(h.marker, h),
            this._fireUnsnap(this._layer, h));
        return !0;
      },
      _createSnapList() {
        let t = [],
      ...
      _calcClosestLayers(t, e, i = 1) {
        ...
        (e.forEach((a, o) => {
          ...
          if (
            ((h.distance = Math.floor(h.distance)), this.debugIndicatorLines)
          ) {
            if (!this.debugIndicatorLines[o]) {
              let l = L.polyline([], { color: 'red', pmIgnore: !0 });
              ((l._pmTempLayer = !0), (this.debugIndicatorLines[o] = l));
            }
            this.debugIndicatorLines[o].setLatLngs([t, h.latlng]);
          }
          i === 1 && (n.distance === void 0 || h.distance - 5 <= n.distance)
            ? (h.distance + 5 < n.distance && (r = []),
              (n = h),
              (n.layer = a),
              r.push(n))
            : i !== 1 && ((n = {}), (n = h), (n.layer = a), r.push(n));
        }),
            ...
            h.forEach((l, d) => {
              ...
              if (this.options.snapSegment) {
                let f = l,
                  k;
                r
                  ? (k = d + 1 === h.length ? 0 : d + 1)
                  : (k = d + 1 === h.length ? void 0 : d + 1);
                let w = h[k];
                if (w) {
      ...
      _checkPrioritiySnapping(t) {
        ...
        if (this.options.snapVertex) {
          ...
          if (this.options.snapMiddle) {
            let f = L.PM.Utils.calcMiddleLatLng(e, i, r),
              k = this._getDistance(e, f, n);
            k < a && k < o && ((h = f), (l = k));
          }
      ...
      _getClosestPointOnSegment(t, e, i, r) {
        ...
        let s = t.project(e, n),
          a = t.project(i, n),
          o = t.project(r, n),
          h = L.LineUtil.closestPointOnSegment(s, a, o);
  ...
  var $g = L.Class.extend({
      ...
      setPathOptions(t, e = !1) {
        e
          ? (this.options.pathOptions = (0, Ao.default)(
  ...
  Y.Marker = Y.extend({
    ...
    disable() {
      this._enabled &&
        ...
        this._isTouchDevice
          ? (this._removeTouchHint(), (this._hintMarker = null))
    ...
    _createTouchHint() {
      this.options.tooltips &&
        ...
        (this._touchHint.textContent = F('tooltips.placeMarkerTouch')),
        this._map.getContainer().appendChild(this._touchHint));
    },
    _removeTouchHint() {
      this._touchHint &&
        this._touchHint.parentNode &&
  ...
  function Qg(t, e, i, r, n, s, a, o) {
    let h,
      l,
      d,
      f,
      k,
      w = { x: null, y: null, onLine1: !1, onLine2: !1 };
    return (
      (h = (o - s) * (i - t) - (a - n) * (r - e)),
      h === 0
        ? w.x !== null && w.y !== null
  ...
  Y.Line = Y.extend({
    ...
    enable(t) {
      (L.Util.setOptions(this, t),
        ...
        this.options.tooltips &&
          this._hintMarker
            .bindTooltip(F('tooltips.firstVertex'), {
              permanent: !0,
              offset: L.point(0, 10),
              direction: 'bottom',
              opacity: 0.8,
    ...
    _setTooltipText() {
      let { length: t } = this._layer.getLatLngs().flat(),
        e = '';
      (t <= 1
        ? (e = F('tooltips.continueLine'))
        : (e = F('tooltips.finishLine')),
  ...
  Y.Rectangle = Y.extend({
    ...
    _placeStartingMarkers(t) {
      ...
      (L.DomUtil.addClass(this._startMarker._icon, 'visible'),
        ...
        this._hintMarker.setTooltipContent(F('tooltips.finishRect')),
    ...
    _syncRectangleSize() {
      let t = ki(this._startMarker.getLatLng(), this._map),
        e = ki(this._hintMarker.getLatLng(), this._map),
  ...
  Y.CircleMarker = Y.extend({
    ...
    enable(t) {
      if (
        ...
        (this._map.on('click', this._createMarker, this),
          ...
          this.options.tooltips &&
            this._hintMarker
              .bindTooltip(F('tooltips.placeCircleMarker'), {
                permanent: !0,
                offset: L.point(0, 10),
                direction: 'bottom',
                opacity: 0.8,
    ...
    _placeCircleCenter() {
      ...
      t &&
        ...
        this._hintMarker.setTooltipContent(F('tooltips.finishCircle')),
    ...
    _getNewDestinationOfHintMarker() {
      ...
      if (this.options[this._editableOption]) {
        ...
        this.options[this._minRadiusOption] &&
        i < this.options[this._minRadiusOption]
          ? (t = Zt(this._map, e, t, this._getMinDistanceInMeter()))
          : this.options[this._maxRadiusOption] &&
            i > this.options[this._maxRadiusOption] &&
            (t = Zt(this._map, e, t, this._getMaxDistanceInMeter()));
      }
      return t;
    },
  ...
  var ze = class {
    ...
    pop() {
      ...
      let e = this.data[0],
        i = this.data.pop();
      return (
        this.length--, this.length > 0 && ((this.data[0] = i), this._down(0)), e
      );
    }
    peek() {
      return this.data[0];
    ...
    _down(e) {
      ...
      for (; e < n; ) {
        let a = (e << 1) + 1,
          ...
          h = a + 1;
        if (
          (h < this.length && r(i[h], o) < 0 && ((a = h), (o = i[h])),
          r(o, s) >= 0)
        )
          break;
        ((i[e] = o), (e = a));
  ...
  function im(t, e) {
    if (t.type === 'FeatureCollection') {
      let i = t.features;
      for (let r = 0; r < i.length; r++) No(i[r], e);
    } else No(t, e);
  }
  var Ge = 0,
    qe = 0,
    Ne = 0;
  function No(t, e) {
    let i = t.type === 'Feature' ? t.geometry : t,
      r = i.coordinates;
    ((i.type === 'Polygon' || i.type === 'MultiLineString') && (r = [r]),
      i.type === 'LineString' && (r = [[r]]));
    for (let n = 0; n < r.length; n++)
      for (let s = 0; s < r[n].length; s++) {
        ...
        for (let h = 0; h < r[n][s].length - 1; h++) {
          o = r[n][s][h + 1];
          let l = new Fe(a, Ge, qe, Ne),
            d = new Fe(o, Ge, qe, Ne + 1);
          ((l.otherEvent = d),
            (d.otherEvent = l),
            zo(l, d) > 0
              ? ((d.isLeftEndpoint = !0), (l.isLeftEndpoint = !1))
              : ((l.isLeftEndpoint = !0), (d.isLeftEndpoint = !1)),
            e.push(l),
            e.push(d),
            (a = o),
            (Ne = Ne + 1));
  ...
  function rm(t, e) {
    if (
      ...
      return !1;
    let i = t.leftSweepEvent.p.x,
      r = t.leftSweepEvent.p.y,
      n = t.rightSweepEvent.p.x,
      s = t.rightSweepEvent.p.y,
      a = e.leftSweepEvent.p.x,
      o = e.leftSweepEvent.p.y,
      h = e.rightSweepEvent.p.x,
  ...
  function sm(t, e) {
    let i = new ze([], zo);
    return (im(t, i), nm(i, e));
  }
  var Fo = sm;
  var am = Fo;
  function Ci(t, e, i = {}) {
    let { removeDuplicates: r = !0, ignoreSelfIntersections: n = !0 } = i,
      s = [];
    ...
    if (t !== null)
      for (
        var r,
          ...
          k,
          w = t.type,
          S = w === 'FeatureCollection',
          A = w === 'Feature',
          g = S ? t.features.length : 1,
          M = 0;
        M < g;
        M++
      ) {
        ((l = S ? t.features[M].geometry : A ? t.geometry : t),
          (k = l ? l.type === 'GeometryCollection' : !1),
          (o = k ? l.geometries.length : 1));
        for (var m = 0; m < o; m++) {
          var O = 0,
            R = 0;
          if (((a = k ? l.geometries[m] : l), a !== null)) {
            ...
            var I = a.type;
            switch (
              ((d = i && (I === 'Polygon' || I === 'MultiPolygon') ? 1 : 0), I)
            ) {
              case null:
                break;
              case 'Point':
              ...
              case 'GeometryCollection':
                for (r = 0; r < a.geometries.length; r++)
                  if (Le(a.geometries[r], e, i) === !1) return !1;
                break;
              default:
  ...
  function om(t, e) {
    var i,
      ...
      f,
      k = 0,
      w = t.type === 'FeatureCollection',
      S = t.type === 'Feature',
      A = w ? t.features.length : 1;
    for (i = 0; i < A; i++) {
      for (
        o = w ? t.features[i].geometry : S ? t.geometry : t,
          l = w ? t.features[i].properties : S ? t.properties : {},
          d = w ? t.features[i].bbox : S ? t.bbox : void 0,
          f = w ? t.features[i].id : S ? t.id : void 0,
          h = o ? o.type === 'GeometryCollection' : !1,
          a = h ? o.geometries.length : 1,
          n = 0;
        n < a;
        n++
      ) {
        ...
        switch (s.type) {
          ...
          case 'GeometryCollection': {
            for (r = 0; r < s.geometries.length; r++)
              if (e(s.geometries[r], k, l, d, f) === !1) return !1;
            break;
          }
          default:
            throw new Error('Unknown Geometry Type');
  ...
  function te(t, e) {
    om(t, function (i, r, n, s, a) {
      ...
      switch (o) {
        ...
        case 'LineString':
        case 'Polygon':
          return e(ct(i, n, { bbox: s, id: a }), r, 0) === !1 ? !1 : void 0;
      }
      var h;
      switch (o) {
        case 'MultiPoint':
      ...
      for (var l = 0; l < i.coordinates.length; l++) {
        var d = i.coordinates[l],
          f = { type: h, coordinates: d };
        if (e(ct(f, n), r, l) === !1) return !1;
      }
    });
  }
  function ut(t, e = {}) {
  ...
  var lm = class {
    constructor(t = 9) {
      ((this.tree = new Uo.default(t)), (this.tree.toBBox = Si));
    }
    insert(t) {
  ...
  function um(t, e) {
    ...
    return (
      t.reduce((r, n) => {
        let s = Bt([r, n], e);
        return ((s.bbox = pm(r, n)), i.push(s), n);
      }),
      i
    );
  }
  ...
  function je(t, e, i = {}) {
    var r = st(t),
      ...
      l =
        ...
        Math.pow(Math.sin(a / 2), 2) * Math.cos(o) * Math.cos(h);
    return qo(2 * Math.atan2(Math.sqrt(l), Math.sqrt(1 - l)), i.units);
  }
  var fm = Object.defineProperty,
    ...
    Yo = (t, e, i) =>
      e in t
        ? fm(t, e, { enumerable: !0, configurable: !0, writable: !0, value: i })
        : (t[e] = i),
    ym = (t, e) => {
      for (var i in e || (e = {})) mm.call(e, i) && Yo(t, i, e[i]);
      if (Xo) for (var i of Xo(e)) _m.call(e, i) && Yo(t, i, e[i]);
      return t;
    },
    Lm = (t, e) => dm(t, gm(e));
  function $o(t, e, i = {}) {
        ...
        for (let k = 0; k < f.length - 1; k++) {
          ...
          if (R < n.properties.pointDistance) {
            ...
            ((n = bt(m, {
              ...
              (n.properties = Lm(ym({}, n.properties), {
  ...
  function Ii(t, e) {
    ...
    switch ((t.type !== 'Feature' && (t = ct(t)), r)) {
      ...
      case 'Polygon':
      case 'MultiPolygon':
        return Zo(t, Ci(t, n, { ignoreSelfIntersections: !0 }));
    }
  }
  function Zo(t, e) {
    var i = [],
  ...
  function Oi(t, e) {
    var i = [],
      r = mt(t)[0],
      n = mt(t)[t.geometry.coordinates.length - 1];
      ...
      d = Vo(
        ...
        function (f, k, w) {
          var S = mt(k)[1],
            A = st(e);
          return w === h.id
            ? (f.push(A), i.push(Bt(f)), Ri(A, S) ? [A] : [A, S])
            : (f.push(S), f);
        },
        l
      );
    return (d.length > 1 && i.push(Bt(d)), rt(i));
  }
  function Wo(t, e) {
  ...
  function Ai(t, e, i, r, n, s) {
    let a = (e - s) * (i - n),
      ...
      h = a - o,
      l = Math.abs(a + o);
    return Math.abs(h) >= vm * l ? h : -Cm(t, e, i, r, n, s, l);
  }
  var Jk = (7 + 56 * V) * V,
    $k = (3 + 28 * V) * V,
    Zk = (26 + 288 * V) * V * V,
  ...
  function re(t, e, i = {}) {
    ...
    for (let s = 0; s < n.length - 1; s++) {
      ...
      if (
        ...
        Sm(n[s], n[s + 1], r, a, typeof i.epsilon > 'u' ? null : i.epsilon))
      )
        return !0;
    }
    return !1;
  }
  function Sm(t, e, i, r, n) {
    let s = i[0],
      a = i[1],
      o = t[0],
      h = t[1],
    ...
    if (Math.abs(w) === Math.abs(S) && Math.abs(w) === 0)
      return r ? !1 : i[0] === t[0] && i[1] === t[1];
    if (r) {
      if (r === 'start')
        return Math.abs(w) >= Math.abs(S)
          ? w > 0
            ? o < s && s <= l
            : l <= s && s < o
          : S > 0
  ...
  function Bm(t, e) {
    ...
    switch (n) {
      ...
      case 'Polygon':
        switch (s) {
          case 'Point':
            return Nt(r, i, { ignoreBoundary: !0 });
          case 'LineString':
            return Nm(i, r);
          case 'Polygon':
            return Gi(i, r);
  ...
  function Tm(t, e) {
    return t.coordinates.some((i) =>
      Gi({ type: 'Polygon', coordinates: i }, e)
    );
  }
  function Dm(t, e) {
    return e.coordinates.every((i) =>
      Gi(t, { type: 'Polygon', coordinates: i })
    );
  }
  function Rm(t, e) {
    let i,
    ...
    for (i = 0; i < t.coordinates.length; i++)
      if (qi(t.coordinates[i], e.coordinates)) {
        r = !0;
        break;
      }
    return r;
  ...
  function Im(t, e) {
    ...
    for (let r of e.coordinates)
      if ((re(r, t, { ignoreEndVertices: !0 }) && (i = !0), !re(r, t)))
        return !1;
    return !!i;
  }
  function Am(t, e) {
    for (let i of e.coordinates)
      if (!Nt(i, t, { ignoreBoundary: !0 })) return !1;
    return !0;
  }
  function Gm(t, e) {
    let i = !1;
    for (let r of e.coordinates)
      if (
        (re({ type: 'Point', coordinates: r }, t, { ignoreEndVertices: !0 }) &&
          (i = !0),
        !re({ type: 'Point', coordinates: r }, t, { ignoreEndVertices: !1 }))
      )
        return !1;
    return i;
  }
  ...
  function Nm(t, e) {
    ...
    for (let a of s.features) {
      let o = zm(a.geometry.coordinates[0], a.geometry.coordinates[1]);
      if (!Nt(o, t)) return !1;
  ...
  var Fm = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i,
    ...
    ft = Math.floor,
    ot = '[BigNumber Error] ',
    ol = ot + 'Number primitive has more than 15 significant digits: ',
    _t = 1e14,
    j = 14,
    zi = 9007199254740991,
    Fi = [
  ...
  function ll(t) {
    var e,
      i,
      r,
      n = (m.prototype = { constructor: m, toString: null, valueOf: null }),
      s = new m(1),
      a = 20,
      o = 4,
      h = -7,
    ...
    function m(c, u) {
      ...
      if (u == null) {
        ...
        if ((b = typeof c == 'number') && c * 0 == 0) {
          ...
          if (!Fm.test((P = String(c)))) return r(C, P, b);
          C.s = P.charCodeAt(0) == 45 ? ((P = P.slice(1)), -1) : 1;
        }
        ((v = P.indexOf('.')) > -1 && (P = P.replace('.', '')),
          (E = P.search(/e/i)) > 0
            ? (v < 0 && (v = E),
              (v += +P.slice(E + 1)),
              (P = P.substring(0, E)))
        ...
        if (($(u, 2, g.length, 'Base'), u == 10 && M))
          return ((C = new m(c)), G(C, a + C.e + 1, o));
        if (((P = String(c)), (b = typeof c == 'number'))) {
          if (c * 0 != 0) return r(C, P, b, u);
          if (
            ((C.s = 1 / c < 0 ? ((P = P.slice(1)), -1) : 1),
            m.DEBUG && P.replace(/^0\.0*|\./, '').length > 15)
          )
            throw Error(ol + c);
        } else C.s = P.charCodeAt(0) === 45 ? ((P = P.slice(1)), -1) : 1;
        for (p = g.slice(0, u), v = E = 0, x = P.length; E < x; E++)
          if (p.indexOf((y = P.charAt(E))) < 0) {
            if (y == '.') {
              if (E > v) {
                v = x;
                continue;
      ...
      if ((P = P.slice(E, ++x))) {
        if (((x -= E), b && m.DEBUG && x > 15 && (c > zi || c !== ft(c))))
          throw Error(ol + C.s * c);
        if ((v = v - E - 1) > f) C.c = C.e = null;
        else if (v < d) C.c = [(C.e = 0)];
        else {
          if (
            ((C.e = v), (C.c = []), (E = (v + 1) % j), v < 0 && (E += j), E < x)
          ) {
            for (E && C.c.push(+P.slice(0, E)), x -= j; E < x; )
              C.c.push(+P.slice(E, (E += j)));
    ...
    ((m.clone = ll),
      ...
      (m.config = m.set =
        function (c) {
          ...
          if (c != null)
            if (typeof c == 'object') {
              if (
                (c.hasOwnProperty((u = 'DECIMAL_PLACES')) &&
                  ((p = c[u]), $(p, 0, et, u), (a = p)),
                c.hasOwnProperty((u = 'ROUNDING_MODE')) &&
                  ((p = c[u]), $(p, 0, 8, u), (o = p)),
                c.hasOwnProperty((u = 'EXPONENTIAL_AT')) &&
                  ((p = c[u]),
                  p && p.pop
                    ? ($(p[0], -et, 0, u),
                      $(p[1], 0, et, u),
                      (h = p[0]),
                      (l = p[1]))
                    : ($(p, -et, et, u), (h = -(l = p < 0 ? -p : p)))),
                c.hasOwnProperty((u = 'RANGE')))
              )
                if (((p = c[u]), p && p.pop))
                  ($(p[0], -et, -1, u),
                    $(p[1], 1, et, u),
              ...
              if (
                (c.hasOwnProperty((u = 'MODULO_MODE')) &&
                  ((p = c[u]), $(p, 0, 9, u), (w = p)),
                c.hasOwnProperty((u = 'POW_PRECISION')) &&
                  ((p = c[u]), $(p, 0, et, u), (S = p)),
                c.hasOwnProperty((u = 'FORMAT')))
              )
                if (((p = c[u]), typeof p == 'object')) A = p;
      ...
      (m.isBigNumber = function (c) {
        ...
        t: if ({}.toString.call(y) == '[object Array]') {
          if ((v === 1 || v === -1) && _ >= -et && _ <= et && _ === ft(_)) {
            ...
            if (
              ((u = (_ + 1) % j), u < 1 && (u += j), String(y[0]).length == u)
            ) {
              for (u = 0; u < y.length; u++)
                if (((p = y[u]), p < 0 || p >= _t || p !== ft(p))) break t;
              if (p !== 0) return !0;
            }
          }
        } else if (
      ...
      (m.random = (function () {
        ...
        return function (p) {
          var y,
            ...
            P = [],
            C = new m(s);
          if ((p == null ? (p = a) : $(p, 0, et), (E = Ni(p / j)), k))
            if (crypto.getRandomValues) {
              for (
                y = crypto.getRandomValues(new Uint32Array((E *= 2)));
                x < E;
              )
                ((b = y[x] * 131072 + (y[x + 1] >>> 11)),
                  b >= 9e15
              ...
              for (y = crypto.randomBytes((E *= 7)); x < E; )
                ((b =
                  (y[x] & 31) * 281474976710656 +
                  y[x + 1] * 1099511627776 +
                  y[x + 2] * 4294967296 +
                  y[x + 3] * 16777216 +
                  (y[x + 4] << 16) +
      ...
      (m.sum = function () {
        for (var c = 1, u = arguments, p = new m(u[0]); c < u.length; )
          p = p.plus(u[c++]);
        return p;
      }),
      (i = (function () {
        ...
        function u(p, y, _, v) {
          for (var E, b = [0], x, P = 0, C = p.length; P < C; ) {
            ...
            for (b[0] += v.indexOf(p.charAt(P++)), E = 0; E < b.length; E++)
              b[E] > _ - 1 &&
                (b[E + 1] == null && (b[E + 1] = 0),
                (b[E + 1] += (b[E] / _) | 0),
                (b[E] %= _));
        ...
        return function (p, y, _, v, E) {
          ...
          for (
            Z >= 0 &&
              ...
              (N = K.pow(p.length - Z)),
              (S = C),
              (K.c = u(Mt(pt(N.c), N.e, '0'), 10, _, c)),
              (K.e = K.c.length)),
              z = u(p, y, _, E ? ((b = g), c) : ((b = c), g)),
              P = C = z.length;
            z[--C] == 0;
            z.pop()
          );
          ...
          if (
            ...
            p = B ? Mt(b.charAt(1), -tt, b.charAt(0)) : b.charAt(0);
          else {
            if (((z.length = x), B))
              for (--_; ++z[--x] > _; )
                ((z[x] = 0), x || (++P, (z = [1].concat(z))));
            for (C = z.length; !z[--C]; );
      ...
      (e = (function () {
        ...
        return function (y, _, v, E, b) {
          ...
          if ((W[C] > (nt[C] || 0) && P--, ht < 0)) (tt.push(1), (B = !0));
          else {
            for (
              We = nt.length,
                yt = W.length,
              ...
              if (((N = 0), (x = u(W, U, yt, H)), x < 0)) {
                if (
                  ...
                  for (
                    ...
                    (N--, p(z, yt < K ? ne : W, K, b), (K = z.length), (x = 1));
    ...
    function R(c, u) {
      for (var p, y, _ = 1, v = new m(c[0]); _ < c.length; _++)
        ((y = new m(c[_])),
          (!y.s || (p = zt(v, y)) === u || (p === 0 && v.s === u)) && (v = y));
      return v;
    }
    function I(c, u, p) {
    ...
    r = (function () {
      ...
      return function (v, E, b, x) {
        ...
        if (y.test(C)) v.s = isNaN(C) ? null : C < 0 ? -1 : 1;
          ...
          if (
            !b &&
            ((C = C.replace(c, function (B, N, z) {
              return (
                (P = (z = z.toLowerCase()) == 'x' ? 16 : z == 'b' ? 2 : 8),
                !x || x == P ? N : B
              );
            })),
            x && ((P = x), (C = C.replace(u, '$1').replace(p, '0.$1'))),
            E != C)
          )
            return new m(C, P);
          if (m.DEBUG)
            throw Error(
              ot + 'Not a' + (x ? ' base ' + x : '') + ' number: ' + E
            );
          v.s = null;
        }
        v.c = v.e = null;
    ...
    function G(c, u, p, y) {
      ...
      if (B) {
        t: {
          for (_ = 1, b = B[0]; b >= 10; b /= 10, _++);
          if (((v = u - _), v < 0))
            ((v += j),
              (E = u),
              (x = B[(P = 0)]),
              (C = ft((x / N[_ - E - 1]) % 10)));
          else if (((P = Ni((v + 1) / j)), P >= B.length))
            if (y) {
              for (; B.length <= P; B.push(0));
              ((x = C = 0), (_ = 1), (v %= j), (E = v - j + 1));
            } else break t;
          else {
            for (x = b = B[P], _ = 1; b >= 10; b /= 10, _++);
            ((v %= j),
              (E = v - j + _),
              (C = E < 0 ? 0 : ft((x / N[_ - E - 1]) % 10)));
          }
          if (
            ((y =
              y || u < 0 || B[P + 1] != null || (E < 0 ? x : x % N[_ - E - 1])),
            (y =
              p < 4
                ? (C || y) && (p == 0 || p == (c.s < 0 ? 3 : 2))
                : C > 5 ||
    ...
    return (
      ...
      (n.decimalPlaces = n.dp =
        function (c, u) {
          ...
          if (((y = ((_ = p.length - 1) - dt(this.e / j)) * j), (_ = p[_])))
            for (; _ % 10 == 0; _ /= 10, y--);
          return (y < 0 && (y = 0), y);
        }),
      (n.dividedBy = n.div =
      ...
      (n.exponentiatedBy = n.pow =
        function (c, u) {
          var p,
            ...
            C,
            B = this;
          if (((c = new m(c)), c.c && !c.isInteger()))
            throw Error(ot + 'Exponent not an integer: ' + q(c));
          if (
            (u != null && (u = new m(u)),
            (b = c.e > 14),
            !B.c ||
            ...
            return (
              (C = new m(Math.pow(+q(B), b ? c.s * (2 - Ve(c)) : +q(c)))),
              u ? C.mod(u) : C
            );
          if (((x = c.s < 0), u)) {
            ...
            if (
              ...
              (B.e > 0 ||
                B.e < -1 ||
                (B.e == 0
                  ? B.c[0] > 1 || (b && B.c[1] >= 24e7)
                  : B.c[0] < 8e13 || (b && B.c[0] <= 9999975e7)))
            )
              return (
                (v = B.s < 0 && Ve(c) ? -0 : 0),
                B.e > -1 && (v = 1 / v),
          ...
          for (
            b
              ? ((p = new m(0.5)), x && (c.s = 1), (P = Ve(c)))
              : ((_ = Math.abs(+q(c))), (P = _ % 2)),
              C = new m(s);
            ;
          ) {
            if (P) {
            ...
            if (_) {
              ...
              P = _ % 2;
            } else if (((c = c.times(p)), G(c, c.e + 1, 1), c.e > 14))
              P = Ve(c);
            else {
              if (((_ = +q(c)), _ === 0)) break;
              P = _ % 2;
            ...
            ((B = B.times(B)),
              v
                ? B.c && B.c.length > v && (B.c.length = v)
                : y && (B = B.mod(u)));
          }
          return y
            ? C
            : (x && (C = s.div(C)), u ? C.mod(u) : v ? G(C, S, o, E) : C);
        }),
      ...
      (n.minus = function (c, u) {
        ...
        var x = E.e / j,
          ...
          B = c.c;
        if (!x || !P) {
          if (!C || !B) return C ? ((c.s = -u), c) : new m(B ? E : NaN);
          if (!C[0] || !B[0])
            return B[0] ? ((c.s = -u), c) : new m(C[0] ? E : o == 3 ? -0 : 0);
        }
        if (((x = dt(x)), (P = dt(P)), (C = C.slice()), (b = x - P))) {
          for (
            (v = b < 0) ? ((b = -b), (_ = C)) : ((P = x), (_ = B)),
              _.reverse(),
              u = b;
            u--;
            _.push(0)
          ...
          for (
            y = (v = (b = C.length) < (u = B.length)) ? b : u, b = u = 0;
            u < y;
            u++
          )
            if (C[u] != B[u]) {
        ...
        if (
          (v && ((_ = C), (C = B), (B = _), (c.s = -c.s)),
          (u = (y = B.length) - (p = C.length)),
          u > 0)
        )
          for (; u--; C[p++] = 0);
        for (u = _t - 1; y > b; ) {
      ...
      (n.multipliedBy = n.times =
        function (c, u) {
          ...
          if (!H || !it || !H[0] || !it[0])
            return (
              !U.s || !c.s || (H && !H[0] && !it) || (it && !it[0] && !H)
                ? (c.c = c.e = c.s = null)
                : ((c.s *= U.s),
                  !H || !it ? (c.c = c.e = null) : ((c.c = [0]), (c.e = 0))),
              c
            );
          for (
            y = dt(U.e / j) + dt(c.e / j),
              ...
              x = H.length,
              B = it.length,
              x < B && ((K = H), (H = it), (it = K), (_ = x), (x = B), (B = _)),
              _ = x + B,
              K = [];
            _--;
            K.push(0)
          );
          for (Z = _t, tt = Rt, _ = B; --_ >= 0; ) {
            for (
              p = 0, N = it[_] % tt, z = (it[_] / tt) | 0, E = x, v = _ + E;
              v > _;
            )
              ((P = H[--E] % tt),
                (C = (H[E] / tt) | 0),
      ...
      (n.plus = function (c, u) {
        ...
        for (
          _ = b.length,
            u = x.length,
            _ - u < 0 && ((p = x), (x = b), (b = p), (u = _)),
            _ = 0;
          u;
        )
          ((_ = ((b[--u] = b[u] + x[u] + _) / _t) | 0),
            (b[u] = _t === b[u] ? 0 : b[u] % _t));
      ...
      (n.precision = n.sd =
        function (c, u) {
          ...
          if (c != null && c !== !!c)
            return (
              $(c, 1, et), u == null ? (u = o) : $(u, 0, 8), G(new m(v), c, u)
            );
          if (!(p = v.c)) return null;
      ...
      (n.squareRoot = n.sqrt =
        function () {
          var c,
            ...
            C = new m('0.5');
          if (b !== 1 || !E || !E[0])
            return new m(!b || (b < 0 && (!E || E[0])) ? NaN : E ? v : 1 / 0);
          if (
            ((b = Math.sqrt(+q(v))),
            b == 0 || b == 1 / 0
              ? ((u = pt(E)),
                ...
                b == 1 / 0
                  ? (u = '5e' + x)
                  : ((u = b.toExponential()),
                    (u = u.slice(0, u.indexOf('e') + 1) + x)),
                (p = new m(u)))
              : (p = new m(b + '')),
            p.c[0])
          ) {
            for (x = p.e, b = x + P, b < 3 && (b = 0); ; )
              if (
                ((_ = p),
                (p = C.times(_.plus(e(v, _, P, 1)))),
                pt(_.c).slice(0, b) === (u = pt(p.c)).slice(0, b))
              )
                if (
                  (p.e < x && --b,
                  (u = u.slice(b - 3, b + 1)),
                  ...
                  (!+u || (!+u.slice(1) && u.charAt(0) == '5')) &&
                    (G(p, p.e + a + 2, 1), (c = !p.times(p).eq(v)));
                  break;
                }
          }
      ...
      (n.toFixed = function (c, u) {
        return (
          c != null && ($(c, 0, et), (c = c + this.e + 1)), O(this, c, u)
        );
      }),
      (n.toFormat = function (c, u, p) {
        var y,
          _ = this;
        if (p == null)
          c != null && u && typeof u == 'object'
            ? ((p = u), (u = null))
            : c && typeof c == 'object'
              ? ((p = c), (c = u = null))
              : (p = A);
        else if (typeof p != 'object')
          throw Error(ot + 'Argument not an object: ' + p);
        if (((y = _.toFixed(c, u)), _.c)) {
          var v,
            E = y.split('.'),
            b = +p.groupSize,
            x = +p.secondaryGroupSize,
            P = p.groupSeparator || '',
            C = E[0],
            B = E[1],
            N = _.s < 0,
          ...
          if ((x && ((v = b), (b = x), (x = v), (K -= v)), b > 0 && K > 0)) {
            for (v = K % b || b, C = z.substr(0, v); v < K; v += b)
              C += P + z.substr(v, b);
      ...
      (n.toFraction = function (c) {
        ...
        if (
          c != null &&
          ((b = new m(c)), (!b.isInteger() && (b.c || b.s !== 1)) || b.lt(s))
        )
          throw Error(
            ot +
              'Argument ' +
        ...
        for (
          u = new m(s),
            ...
            y = x = new m(s),
            N = pt(K),
            v = u.e = N.length - z.e - 1,
            u.c[0] = Fi[(E = v % j) < 0 ? j + E : E],
            c = !c || b.comparedTo(u) > 0 ? (v > 0 ? u : P) : b,
            E = f,
            f = 1 / 0,
            b = new m(N),
            x.c[0] = 0;
          (C = e(b, u, 0, 1)), (_ = p.plus(C.times(y))), _.comparedTo(c) != 1;
        )
          ((p = y),
            (y = _),
            (P = x.plus(C.times((_ = P)))),
            (x = _),
            (u = b.minus(C.times((_ = u)))),
            (b = _));
        return (
          (_ = e(c.minus(p), y, 0, 1)),
          (x = x.plus(_.times(P))),
          ...
          (B =
            e(P, y, v, o)
              .minus(z)
              .abs()
              .comparedTo(e(x, p, v, o).minus(z).abs()) < 1
              ? [P, y]
              : [x, p]),
          (f = E),
          B
        ...
        return (
          _ === null
            ? y
              ...
              : (u = 'NaN')
            : (c == null
                ? (u = _ <= h || _ >= l ? Ue(pt(p.c), _) : Mt(pt(p.c), _, '0'))
                : c === 10 && M
                  ? ((p = G(new m(p), a + _ + 1, o)),
                    (u = Mt(pt(p.c), p.e, '0')))
                  : ($(c, 2, g.length, 'Base'),
                    (u = i(Mt(pt(p.c), _, '0'), 10, c, y, !0))),
              y < 0 && p.c[0] && (u = '-' + u)),
          u
        );
      }),
  ...
  function zt(t, e) {
    ...
    for (o = (h = n.length) < (l = s.length) ? h : l, a = 0; a < o; a++)
  ...
  var gl = (t) => () => t,
    ji = (t) => {
      let e = t ? (i, r) => r.minus(i).abs().isLessThanOrEqualTo(t) : gl(!1);
    ...
    return (i, r, n) => {
      let s = i.x,
        ...
        l = a
          .minus(h)
          .times(r.x.minus(o))
          .minus(s.minus(o).times(r.y.minus(h)));
  ...
  var Ym = (t) => t,
    ...
    ml = (t, e) => t.x.times(e.x).plus(t.y.times(e.y)),
    Xe = (t) => ml(t, t).sqrt(),
    $m = (t, e, i) => {
    ...
    Zm = (t, e, i) => {
      let r = { x: e.x.minus(t.x), y: e.y.minus(t.y) },
        n = { x: i.x.minus(t.x), y: i.y.minus(t.y) };
      return ml(n, r).div(Xe(n)).div(Xe(r));
    },
    cl = (t, e, i) =>
      e.y.isZero()
        ? null
    ...
    Wm = (t, e, i, r) => {
      if (e.x.isZero()) return ul(i, r, t.x);
      if (r.x.isZero()) return ul(t, e, i.x);
      if (e.y.isZero()) return cl(i, r, t.y);
      if (r.y.isZero()) return cl(t, e, i.y);
      let n = Ke(e, r);
      if (n.isZero()) return null;
      let s = { x: i.x.minus(t.x), y: i.y.minus(t.y) },
        a = Ke(s, e).div(n),
        o = Ke(s, r).div(n),
        h = t.x.plus(o.times(e.x)),
        l = i.x.plus(a.times(r.x)),
        d = t.y.plus(o.times(e.y)),
        f = i.y.plus(a.times(r.y)),
        k = h.plus(l).div(2),
        w = d.plus(f).div(2);
      return { x: k, y: w };
    },
    kt = class _l {
      ...
      consumedBy;
      static compare(e, i) {
        let r = _l.comparePoints(e.point, i.point);
        return r !== 0
          ? r
          : (e.point !== i.point && e.link(i),
            e.isLeft !== i.isLeft
              ? e.isLeft
                ? 1
                : -1
              : Je.compare(e.segment, i.segment));
      }
      ...
      getLeftmostComparator(e) {
        let i = new Map(),
          r = (n) => {
            let s = n.otherSE;
            i.set(n, {
              sine: $m(this.point, e.point, s.point),
              cosine: Zm(this.point, e.point, s.point),
            });
          };
        return (n, s) => {
          (i.has(n) || r(n), i.has(s) || r(s));
          let { sine: a, cosine: o } = i.get(n),
            { sine: h, cosine: l } = i.get(s);
          return a.isGreaterThanOrEqualTo(0) && h.isGreaterThanOrEqualTo(0)
            ? o.isLessThan(l)
              ? 1
              : o.isGreaterThan(l)
                ? -1
                : 0
            : a.isLessThan(0) && h.isLessThan(0)
              ? o.isLessThan(l)
                ? -1
                : o.isGreaterThan(l)
                  ? 1
    ...
    Qm = class Ki {
      ...
      static factory(e) {
        ...
        for (let r = 0, n = e.length; r < n; r++) {
          ...
          let a = null,
            ...
            d = o.point,
            f = [];
          for (; (a = o), (o = h), l.push(o), o.point !== d; )
            for (;;) {
              ...
              if (k.length === 0) {
                ...
                throw new Error(
                  `Unable to complete output ring starting at [${A.x}, ${A.y}]. Last matching segment found ends at [${g.x}, ${g.y}].`
                );
              }
              if (k.length === 1) {
                h = k[0].otherSE;
      ...
      getGeom() {
        ...
        for (let l = 1, d = this.events.length - 1; l < d; l++) {
          let f = this.events[l].point,
            k = this.events[l + 1].point;
        ...
        let s = this.isExteriorRing() ? 1 : -1,
          ...
          h = [];
        for (let l = a; l != o; l += s)
          h.push([i[l].x.toNumber(), i[l].y.toNumber()]);
        return h;
      }
      isExteriorRing() {
    ...
    t_ = class {
      ...
      _composePolys(t) {
        ...
        for (let i = 0, r = t.length; i < r; i++) {
          let n = t[i];
          if (!n.poly)
            if (n.isExteriorRing()) e.push(new pl(n));
            else {
              let s = n.enclosingRing();
              (s?.poly || e.push(new pl(s)), s?.poly?.addInterior(n));
            }
        }
        return e;
      }
    ...
    i_ = class {
      ...
      run(t, e, i) {
        Ce.type = t;
        let r = [new dl(e, !0)];
        for (let l = 0, d = i.length; l < d; l++) r.push(new dl(i[l], !1));
        if (((Ce.numMultiPolys = r.length), Ce.type === 'difference')) {
          let l = r[0],
            d = 1;
          for (; d < r.length; )
            Ui(r[d].bbox, l.bbox) !== null ? d++ : r.splice(d, 1);
        }
        if (Ce.type === 'intersection')
          for (let l = 0, d = r.length; l < d; l++) {
            let f = r[l];
            for (let k = l + 1, w = r.length; k < w; k++)
              if (Ui(f.bbox, r[k].bbox) === null) return [];
          }
        ...
        vt.reset();
        let o = Qm.factory(s.segments);
        return new t_(o).getGeom();
      }
    },
    Ce = new i_(),
    Ye = Ce,
    ...
    Je = class He {
      ...
      getIntersection(e) {
        ...
        let s = this.leftSE.point,
          ...
          o = e.leftSE.point,
          h = e.rightSE.point,
          l = we(i, o) && this.comparePoint(o) === 0,
          d = we(r, s) && e.comparePoint(s) === 0,
          f = we(i, h) && this.comparePoint(h) === 0,
          k = we(r, a) && e.comparePoint(a) === 0;
        ...
        if (k) return a;
        if (f) return h;
        let w = Wm(s, this.vector(), o, e.vector());
      ...
      split(e) {
        ...
        return (
          kt.comparePoints(o.leftSE.point, o.rightSE.point) > 0 &&
            o.swapEvents(),
          kt.comparePoints(this.leftSE.point, this.rightSE.point) > 0 &&
            this.swapEvents(),
        ...
        if (n !== 0) {
          ...
          for (let s = 0, a = r.rings.length; s < a; s++) {
            let o = r.rings[s],
              ...
              l = i.rings.indexOf(o);
            l === -1
              ? (i.rings.push(o), i.windings.push(h))
              : (i.windings[l] += h);
          }
          ((r.rings = null),
            (r.windings = null),
        ...
        switch (Ye.type) {
          ...
          case 'intersection': {
            ...
            (e.length < i.length
              ...
              (this._isInResult = n === Ye.numMultiPolys && r < n));
            break;
          }
          case 'xor': {
      ...
      constructor(t, e, i) {
        ...
        for (let s = 1, a = t.length; s < a; s++) {
          ...
          (o.x.eq(n.x) && o.y.eq(n.y)) ||
            (this.segments.push(Je.fromRing(n, o, this)),
        ...
        (!r.x.eq(n.x) || !r.y.eq(n.y)) &&
          this.segments.push(Je.fromRing(n, r, this));
      }
      getSweepEvents() {
        let t = [];
    ...
    n_ = class {
      ...
      constructor(t, e) {
        ...
        ((this.exteriorRing = new fl(t[0], this, !0)),
          (this.bbox = {
            ll: {
  ...
  var yl = (t, ...e) => Ye.run('intersection', t, e);
  var Ll = (t, ...e) => Ye.run('difference', t, e),
    A0 = vt.set;
  function Ze(t) {
    let e = { type: 'Feature' };
  ...
  function vl(t, e) {
    let i = $e(t),
      r = $e(e),
      n = yl(i.coordinates, r.coordinates);
    return n.length === 0 ? null : n.length === 1 ? kl(n[0]) : Ml(n);
  }
  function xl(t, e) {
    let i = $e(t),
      r = $e(e),
      n = Ll(i.coordinates, r.coordinates);
    return n.length === 0 ? null : n.length === 1 ? kl(n[0]) : Ml(n);
  }
  function wl(t) {
    return Array.isArray(t) ? 1 + wl(t[0]) : -1;
  }
  function Cl(t) {
  ...
  Y.Cut = Y.Polygon.extend({
      ...
      Object.keys(e)
        ...
        .filter((n) => {
          try {
            ...
            return s || (n instanceof L.Polyline && !(n instanceof L.Polygon))
              ? s
              : !!vl(t.toGeoJSON(15), n.toGeoJSON(15));
          } catch {
            return (
        ...
        .forEach((n) => {
                ...
                if (k && k.segment && k.distance < this.options.snapDistance) {
                  ...
                  if (w && w.length === 2) {
                    let {
                      ...
                      parentPath: A,
                      newIndex: g,
                    } = L.PM.Utils._getIndexFromSegment(l, w);
                    (S.length > 1 ? (0, Pl.default)(l, A) : l).splice(g, 0, f);
                  }
                }
              }
            });
          ...
          if (
            ...
            h.getLayers &&
              h.getLayers().length === 0 &&
              this._map.pm.removeLayer({ target: h }),
    ...
    _cutLayer(t, e) {
      let i = L.geoJSON(),
        r;
      if (e instanceof L.Polygon) r = xl(e.toGeoJSON(15), t.toGeoJSON(15));
      else {
        let n = Cl(e);
        (n.forEach((s) => {
          let a = Qo(s, t.toGeoJSON(15)),
            o;
          (a && a.features.length > 0 ? (o = L.geoJSON(a)) : (o = L.geoJSON(s)),
            o.getLayers().forEach((h) => {
              al(t.toGeoJSON(15), h.toGeoJSON(15)) || h.addTo(i);
            }));
        }),
          n.length > 1 ? (r = El(i)) : (r = i.toGeoJSON(15)));
      }
      return r;
    },
  ...
  var l_ = {
      enableLayerDrag() {
        ...
        (this.disable(),
          ...
          St(this._layer) instanceof L.Canvas
  ...
  function Hi(t, e, i) {
    ...
    return t instanceof L.LatLng ? h_(t, e, i, r) : null;
  }
  function Ot(t, e) {
  ...
  var c_ = {
      _onRotateStart(t) {
        (this._preventRenderingMarkers(!0),
          ...
          (this._rotationOriginPoint = Ot(
            this._map,
            this._rotationOriginLatLng
          )),
          (this._rotationStartPoint = Ot(this._map, t.target.getLatLng())),
      ...
      _onRotate(t) {
        let e = Ot(this._map, t.target.getLatLng()),
        ...
        let s = this;
        function a(d, f = [], k = -1) {
          if ((k > -1 && f.push(k), L.Util.isArray(d[0])))
            d.forEach((w, S) => a(w, f.slice(), S));
          else {
            let w =
              f.length > 0 ? (0, Bl.default)(s._markers, f) : s._markers[0];
            d.forEach((S, A) => {
              w[A].setLatLng(S);
            });
          }
        ...
        (this._setAngle(l),
          ...
          this._fireRotation(this._rotationLayer, h, o),
          this._fireRotation(this._map, h, o),
      ...
      _rotateLayer(t, e, i, r, n) {
        let s = Ot(n, i);
        return (
          (this._matrix = r.clone().rotate(t, s).flip()), Hi(e, this._matrix, n)
        );
      },
      _setAngle(t) {
    ...
    Tl = c_;
  var u_ = L.Class.extend({
      includes: [Sl, Ae, Tl, Pt],
      options: {
        snappable: !0,
        snapDistance: 20,
        allowSelfIntersection: !0,
  ...
  X.Line = X.extend({
    ...
    _addMarker(t, e, i) {
      ...
      let {
        ...
        h = s.length > 1 ? (0, xt.default)(n, o) : n,
        l = s.length > 1 ? (0, xt.default)(this._markers, o) : this._markers;
      (h.splice(a + 1, 0, r),
        l.splice(a + 1, 0, t),
        this._layer.setLatLngs(n),
        this.options.hideMiddleMarkers !== !0 &&
    ...
    _handleLayerStyle(t) {
      ...
      if (
        (this.options.allowSelfIntersection
          ? (i = !1)
          : ((r = Wt(this._layer.toGeoJSON(15))), (i = r.features.length > 0)),
        i)
      ) {
        if (
          (!this.options.allowSelfIntersection &&
    ...
    _removeMarker(t) {
      ...
      if (!r) return;
      let a = r.length > 1 ? (0, xt.default)(i, s) : i,
        o = r.length > 1 ? (0, xt.default)(this._markers, s) : this._markers,
        h = s[s.length - 1] > 0 && this._layer instanceof L.Polygon;
      if (
      ...
      if (
        ...
        !l &&
          ((o =
            r.length > 1 ? (0, xt.default)(this._markers, s) : this._markers),
          e._middleMarkerPrev &&
        ...
        if (
          (this.isPolygon()
            ? ((d = (n + 1) % o.length), (f = (n + (o.length - 1)) % o.length))
            : ((f = n - 1 < 0 ? void 0 : n - 1),
              (d = n + 1 >= o.length ? void 0 : n + 1)),
          d !== f)
        ) {
          let k = o[f],
            w = o[d];
          this.options.hideMiddleMarkers !== !0 &&
            this._createMiddleMarker(k, w);
        }
        o.splice(n, 1);
      }
      (this._fireEdit(),
    ...
    updatePolygonCoordsFromMarkerDrag(t) {
      let e = this._layer.getLatLngs(),
        ...
        a = r.length > 1 ? (0, xt.default)(e, s) : e;
    ...
    _getNeighborMarkers(t) {
      let {
        ...
        n = e.length > 1 ? (0, xt.default)(this._markers, r) : this._markers,
        s = (i + 1) % n.length,
    ...
    _checkMarkerAllowedToDrag(t) {
      let { prevMarker: e, nextMarker: i } = this._getNeighborMarkers(t),
        ...
        a = Dt(this._layer.toGeoJSON(15), r.toGeoJSON(15)).features.filter(
          (l) => {
            let d = l.geometry.coordinates,
              f = L.latLng(d[1], d[0]);
            return !f.equals(e.getLatLng()) && !f.equals(t.getLatLng());
          }
        ).length,
        h = Dt(this._layer.toGeoJSON(15), n.toGeoJSON(15)).features.filter(
          (l) => {
            let d = l.geometry.coordinates,
              f = L.latLng(d[1], d[0]);
    ...
    _onMarkerDrag(t) {
      ...
      let s = i.length > 1 ? (0, xt.default)(this._markers, n) : this._markers,
        a = (r + 1) % s.length,
  ...
  X.CircleMarker = X.extend({
    ...
    _getNewDestinationOfOuterMarker() {
      ...
      return (
        this.options[this._minRadiusOption] &&
        i < this.options[this._minRadiusOption]
          ? (e = Zt(this._map, t, e, this._getMinDistanceInMeter(t)))
          : this.options[this._maxRadiusOption] &&
            i > this.options[this._maxRadiusOption] &&
            (e = Zt(this._map, t, e, this._getMaxDistanceInMeter(t))),
        e
      );
    },
  ...
  var f_ = {
      ...
      _getRotatedRectangle(t, e, i, r) {
        let n = Ot(r, t),
          ...
          o = Math.cos(a),
          h = Math.sin(a),
          l = (s.x - n.x) * o + (s.y - n.y) * h,
          d = (s.y - n.y) * o - (s.x - n.x) * h,
          f = l * o + n.x,
          k = l * h + n.y,
          w = -d * h + n.x,
          S = d * o + n.y,
